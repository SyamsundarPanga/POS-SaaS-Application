...
const EnhancedPOSTerminal: React.FC = () => {
  ...
  const totalBeforeDiscount = cart.subtotalBeforeDiscount + cart.taxAmount;
  ...
  const finalTotal = Math.max(0, totalBeforeDiscount - loyaltyDiscount - discountAmount);
                ...
                >
                  ...
                  <div className="border-t-2 border-slate-100 pt-4 space-y-2 mb-4">
                    ...
                    <div className="flex justify-between text-slate-700">
                      ...
                      <span className="font-bold">INR {cart.taxableAmount.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-slate-700">
